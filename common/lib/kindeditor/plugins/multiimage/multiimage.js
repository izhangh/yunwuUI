...
KindEditor.plugin('multiimage', function(K) {
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			uploadUrl : K.addParam(uploadJson, 'dir=9D0765CAF78AF208'),
...
SWFUpload.completeURL = function(url) {
	...
	var CurrentPage = window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : "");
