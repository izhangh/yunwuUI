...
;(function($, undefined) {
	...
	$.extend(Modal.prototype, {
		show: function() {
			...
			if (!this.$modal.length) {
				this.$modal = $('<div class="modal fade" tabindex="-1" role="dialog" id="' + this.options.target.substr(1) + '"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" href="#" data-dismiss="HandleFormModal">×</a><h4 class="nomargin">&nbsp;</h4></div><div class="modal-body"/></div></div></div>').appendTo(this.options.appendTo).hide();
			}
	...
	$.fn[pluginName].defaults = {
		title: '&nbsp;'		// modal title
		,target: '#HandleFormModal'	// the modal id. MUST be an id for now.
